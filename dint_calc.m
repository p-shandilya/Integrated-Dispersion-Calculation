...
data = readtable('Dispersion.csv','NumHeaderLines',1); %First column is the azimuthal mode number and second column is the linear resonance frequency
...
fmean = mean(freq); %Mean frequency. Use weighted averages when available
